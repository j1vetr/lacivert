...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground selection:bg-blue-500/30">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white pt-44 sm:pt-48 md:pt-52 lg:pt-44 pb-24 overflow-hidden">
